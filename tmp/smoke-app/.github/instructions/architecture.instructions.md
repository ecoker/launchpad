...
def process_vote(params) do
  # 200 lines of validation, persistence, broadcasting, logging...
end
```

- Prefer **function composition** and **pipelines** over deep call hierarchies.
- Prefer **plain data objects (structs)** over class instances for domain models.
